> Исторический отчёт первоначальной реализации Gateway. Identity теперь подключён;
> текущие команды и проверка связанного MVP находятся в корневом README и deploy/test.
